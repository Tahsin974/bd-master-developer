...
const UiUxTabPanel = () => {
  const uxUiSkills = [
    { category: "UX/UI Design", name: "Wireframing", icon: "layout" },
    { category: "UX/UI Design", name: "Prototyping", icon: "prototype" },
    { category: "UX/UI Design", name: "User Research", icon: "search" },
    { category: "UX/UI Design", name: "Usability Testing", icon: "test" },
    {
      category: "UX/UI Design",
      name: "Information Architecture",
      icon: "hierarchy",
    },
    { category: "UX/UI Design", name: "Visual Design", icon: "palette" },
    { category: "UX/UI Design", name: "Interaction Design", icon: "mouse" },
    { category: "UX/UI Design", name: "UX Writing", icon: "text" },
    { category: "UX/UI Design", name: "Figma", icon: "Figma" },
    { category: "UX/UI Design", name: "Sketch", icon: "Sketch" },
    { category: "UX/UI Design", name: "Adobe XD", icon: "XD" },
  ];
  return (
    <div>
      <div>
            ...
            <SwiperSlide key={index}>
              <div className="card  bg-[#F8FDFE] xl:w-[184px] lg:w-[184px] md:w-[184px] sm:w-[184px]  h-[300px] custom-shadow rounded-2xl border border-gray-100 transition duration-300 ease-in-out hover:-translate-y-4  my-auto   px-3 py-7">
                <div className="items-center  text-center space-y-3.5 ">
                  <div className="w-[100px] py-1.5 px-3.5 mx-auto text-center text-xs text-gray-500 bg-[rgba(176,231,238,0.4)]  rounded-3xl  mb-4">
                    <p>{skill.category}</p>
                  </div>
