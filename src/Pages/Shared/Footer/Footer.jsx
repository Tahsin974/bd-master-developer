  ...
  return (
    <div className="bg-[#0F172A]">
      <div className="max-w-[1280px] mx-auto">
        <footer className="lg:flex xl:flex   gap-10 lg:space-y-0 space-y-6  bg-transparent text-white p-10 ">
      ...
      copyright 
      ------------------------------------------*/}
        <footer className="footer sm:footer-horizontal footer-center bg-transparent text-white p-4 border-t border-gray-700">
          <aside>
            <p>
