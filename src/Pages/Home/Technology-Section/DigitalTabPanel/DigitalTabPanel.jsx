...
const DigitalTabPanel = () => {
  const digitalMarketingSkills = [
    { category: "Digital Marketing", name: "SEO", icon: "seo" },
    { category: "Digital Marketing", name: "SEM", icon: "sem" },
    {
    ...
    { category: "Digital Marketing", name: "Email Marketing", icon: "email" },
    {
      category: "Digital Marketing",
      name: "Data Analysis",
      icon: "analytics",
    },
    { category: "Digital Marketing", name: "PPC Advertising", icon: "ad" },
    { category: "Digital Marketing", name: "Video Marketing", icon: "video" },
    {
      category: "Digital Marketing",
      name: "Marketing Automation",
      icon: "automation",
    },
    { category: "Digital Marketing", name: "CRM Software", icon: "crm" },
  ];
  return (
    <div>
      <div>
